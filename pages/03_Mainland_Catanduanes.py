...
This assessment evaluates whether a generating unit can
consistently deliver meaningful output relative to its
Guaranteed Dependable Capacity (GDC), rather than merely
achieving a high output during a single hour.

### Metrics

#### 1. Capability Realization (%)

Measures the highest output ever achieved by the unit during
the study period.

**Formula**

Capability Realization (%) =
(Maximum Observed MW ÷ Dependable MW) × 100

**Interpretation**

- 100% = Unit reached its dependable capacity at least once.
- Less than 100% = Unit never achieved its dependable capacity.

---

#### 2. Utilization Factor (%)

Measures average utilization throughout the study period.

**Formula**

Utilization Factor (%) =
(Average MW ÷ Dependable MW) × 100

**Interpretation**

- High values indicate the unit was frequently utilized.
- Low values indicate the unit was rarely dispatched.

---

#### 3. Sustained Capability (%)

Measures how often the unit operated at or above 80% of its
dependable capacity while running.

**Formula**

Hours Above 80% =
Count of hours where:

Actual MW ≥ 0.80 × Dependable MW
...
(Hours Above 80% ÷ Operating Hours) × 100

**Interpretation**

- 100% = Every operating hour was above 80% loading.
- 50% = Half of operating hours were above 80% loading.
- 0% = Unit never operated above 80% of dependable capacity.

---

### Risk Classification

| Sustained Capability | Assessment |
|---------------------|------------|
| ≥ 50% | OK |
| 20% to < 50% | Monitor |
| < 20% | Investigate |
...
- Dependable Capacity = 1.0 MW
- Maximum Output = 1.0 MW
- Average Output = 0.2 MW
- Operating Hours = 500
- Hours Above 80% = 5
...
Although the unit achieved 100% capability once,
it rarely sustained dependable output and would be
